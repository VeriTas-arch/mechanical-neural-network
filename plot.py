...
for i in range(N_CORES):
    path = Path(__file__).parent /'storage'/'multiprocessing'/'fitness_data'/f"fitness{i}.csv"
    ...
    path1 = Path(__file__).parent /'storage'/'multiprocessing'/'figures'/ f"fitness{i}_1.png"
    fig1.savefig(path1)
    ...
    path2 = Path(__file__).parent /'storage'/'multiprocessing'/'figures'/ f"fitness{i}_2.png"
    fig2.savefig(path2)
